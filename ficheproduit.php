...
<body>
<iframe src="iframepanel.php?titre=<?php echo $produit[2]; ?>" height="100" width="100%" name="panel"
        frameborder="0"></iframe>
<center>
    <div id="panel" class="hero-unit text-center">
        ...
        Fin de l'offre
        : <?php echo date('d/m/Y', strtotime('+' . $produit[5] . 'day', strtotime($produit[4]))); ?></br></br>
