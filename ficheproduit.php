...
<div class="hero-unit text-center">
            <h1><?php echo $produit[2];
                if ($produit[6]) echo '<img src="./images/vendu.png" width="340" height="240" style="position: absolute; top:200px; left:35%;">'?></h1>
            ...
            <h2>Prix de départ : <?php echo number_format($produit[3], 2, ',', ' ') . "$" ?></h2>
                ...
                <h2>Fin de l'offre
                    : <?php echo date('d/m/Y', strtotime('+' . $produit['5'] . 'day', $produit[3])); ?></h2>
                <h2>Description : </h2><br/> <?php echo $produit[7] . "<br/>" ?>
                <h2>Etat : </h2><br/> <?php echo $produit[9] . "<br/>" ?>
